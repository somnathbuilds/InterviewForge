...
function DSACompanyQuestions() {
  ...
  const { solvedIds, favoriteIds, toggleSolved, toggleFavorite } = useProgress();
        ...
        <div className="flex flex-col xl:flex-row justify-between xl:items-center gap-4 bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <select
              ...
              className="bg-slate-50 border border-slate-200/80 focus:border-blue-500 rounded-xl px-2.5 py-1.5 text-xs outline-none transition focus:ring-1 focus:ring-blue-500 text-slate-800 cursor-pointer max-w-[130px]"
            >
                  ...
                  return (
                    <tr key={prob.id} className="hover:bg-slate-50/50 transition">
                      ...
                      <td className="px-6 py-3.5">
                        <span className={`text-xs font-semibold leading-tight ${isSolved ? "text-slate-400 line-through font-medium" : "text-slate-800"}`}>
                          {prob.name}
                        </span>
                      </td>
                      <td className="px-6 py-3.5 whitespace-nowrap">
                      ...
                      <td className="px-6 py-3.5 whitespace-nowrap">
                        <button
                          onClick={() => toggleFavorite(prob, !isFavorite)}
