...
function Register() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 bg-white relative overflow-y-auto">
        ...
        <div className="w-full max-w-[420px] flex flex-col justify-center my-auto">
          ...
          {validationError && (
            <div className="mb-5 bg-rose-50 border border-rose-100 text-rose-600 text-xs rounded-xl p-3 flex items-center gap-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full border border-slate-200 hover:border-slate-300 focus:border-blue-500 rounded-xl pl-4 pr-11 py-2.5 text-sm outline-none transition focus:ring-1 focus:ring-blue-500 bg-white text-slate-800"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-400 hover:text-slate-600 cursor-pointer select-none"
                >
                  {showPassword ? (
            ...
            {/* Terms Consent */}
            <div className="flex items-start gap-2 select-none py-1">
              <input
                id="terms"
                type="checkbox"
                required
